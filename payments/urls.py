...
urlpatterns = [
    ...
    path('flutterwave/<str:username>/<str:email>/<str:phone_no>/<float:price>/<int:pk>/<slug:slug>/<float:delivery>', views.flutterwave, name='flutterwave'),
    path('paystack/<str:username>/<str:email>/<str:phone_no>/<int:price>/<int:pk>/<slug:slug>/<float:delivery>', views.paystack, name='paystack'),
